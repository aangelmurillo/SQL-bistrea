...
categorias                       1
configs_carusel                  ?
detalles_pedido                  1 //Al pedir algo mayor a lo que hay en stock aparecen negativos  //Cunado se haga un En solicitud y que el cliente no llegue, que pasara con el stock
...
INSERT INTO usuarios (nombre_usuario, apellido_p_usuario, apellido_m_usuario, email_usuario, contrasena_usuario, telefono_usuario) 
			VALUES ('Mariana', 'Herrera', 'Garza', 'mariana@gmail.com', '1234', '8715454545');
