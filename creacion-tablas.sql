...
ALTER TABLE categorias DROP COLUMN img_categoria;
...
ALTER TABLE usuarios MODIFY COLUMN id_rol INT NOT NULL DEFAULT 3;
ALTER TABLE usuarios MODIFY COLUMN creado_en_usuario TIMESTAMP DEFAULT NOW();
